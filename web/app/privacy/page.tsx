...
export default function PrivacyPage() {
  return <main className="privacy-page">
    <nav><Link className="privacy-brand" href="/"><span>C</span><strong>chronicle</strong></Link><Link href="/app">Back to Chronicle →</Link></nav>
    <article>
    ...
    <footer><Link href="/app">← Return to your Chronicle</Link><span>Chronicle · Personal journal</span></footer>
  </main>;
}
